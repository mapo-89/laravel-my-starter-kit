...
return [
    ...
    'attributes'             => [
        ...
        'role'                     => 'Rolle',
        'rows.*.billing_cycle'     => 'Abrechnungszyklus',
        'rows.*.billing_month'     => 'Abrechnungsmonat',
        'rows.*.end_transfer'      => 'Ende Überlassung',
        'rows.*.minimum_quantity'  => 'Mindestabnahmemenge',
        'rows.*.order_number'      => 'Auftragsnummer',
        'rows.*.price'             => 'Preis',
        'rows.*.product'           => 'Produkt',
        'rows.*.purchase_price'    => 'Einkaufspreis',
        'rows.*.sku'               => 'Artikelnummer',
        'rule'                     => 'Regel',
        'rules'                    => 'Regeln',
        'second'                   => 'Sekunde',
        'sex'                      => 'Geschlecht',
