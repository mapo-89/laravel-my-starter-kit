...
defineProps({
  sidebarEnabled: { type: Boolean, default: false },
})
      ...
      <div class="flex justify-between h-16">
        <div class="flex">
          <div class="flex items-center">
            <SidebarTrigger v-if="sidebarEnabled" class="mr-2" />
          </div>
              ...
              <template #content>
                <div class="w-60">
                  <template v-if="$page.props.jetstream.hasTeamFeatures">
                    <div class="block px-4 py-2 text-xs text-gray-400">{{ $t('Manage Team') }}</div>
                    ...
                    <template v-if="$page.props.auth.user.all_teams.length > 1">
                      ...
                      <div class="block px-4 py-2 text-xs text-gray-400">{{ $t('Switch Teams') }}</div>
          ...
          <div class="ml-3 relative">
            <Dropdown align="right" width="48">
              ...
              <template #content>
                ...
                <DropdownLink v-if="$page.props.jetstream.hasApiFeatures" :href="route('api-tokens.index')">{{ $t('API Tokens') }}</DropdownLink>
